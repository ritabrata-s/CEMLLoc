...
I/O info
'''
historyFile = 'history28-set2.json'
modelFile = 'model28-set2.keras'
inpShape = 80
...
def get_convnet_calo_model(out_shape=2, dropout=None):
    ...
    inputCalo    = keras.Input(shape=(inpShape, inpShape, 1))

    # Calo model image
    caloconlayer    = keras.layers.Conv2D(40, (2,2), activation="relu")(inputCalo)
#     caloconlayer    = keras.layers.MaxPooling2D((2,2))(caloconlayer)
    caloconlayer    = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
    caloconlayer    = keras.layers.Conv2D(20, (2,2), activation="relu")(caloconlayer)
#     caloconlayer    = keras.layers.MaxPooling2D((2,2))(caloconlayer)
    caloconlayer    = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
#     caloconlayer    = keras.layers.Conv2D(5, (2,2), activation="relu")(caloconlayer)
#     caloconlayer    = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
#     caloconlayer    = keras.layers.Conv2D(32, (4,4), activation="relu")(caloconlayer)
#     caloconlayer    = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
    
#     print(caloconlayer.shape[1],caloconlayer.shape[2])

    # ... full-size filters of conv net
    caloconlayer    = keras.layers.Conv2D(80, (caloconlayer.shape[1],caloconlayer.shape[2]), activation="relu")(caloconlayer)
    caloconlayer    = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
    caloconlayer    = keras.layers.Flatten()(caloconlayer)

    # Calo model conclude to output shape
#     caloconlayer = keras.layers.Dense(100, activation="relu")(caloconlayer)
#     caloconlayer = keras.layers.Dropout(dropout)(caloconlayer) if dropout else caloconlayer
